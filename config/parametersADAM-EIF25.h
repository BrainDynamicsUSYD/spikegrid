...
#define grid_size 150 // fix to look at small step sizes!
...
#define stimparams .Stim =                          \
    {                                               \
        .ImagePath  = "input_maps/D25_N200.png",    \
        .timeperiod=1e6,                            \
        .lag=1e6,                                   \
...
static const sweepable Sweep =
{
    ...
    .minval = 0.90, // A good value is somewehre between 0.3 to 0.35
    .maxval = 1.05,
    .count = 15,
    .SweepEx = ON,
    .SweepIn = ON,
