...
static const model_features Features = 
{
    ...
    .output = {{ .method=TEXT,.Output=0,.Delay=2}, { .method=TEXT,.Output=1,.Delay=20}, { .method=TEXT,.Output=5,.Delay=20}, { .method=TEXT,.Output=7,.Delay=20}, { .method=SPIKES, .Output=15, .Delay=1}}, 
    // .job=
    // { 
